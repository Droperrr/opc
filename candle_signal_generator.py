...
def generate_candle_signals(data_file='basis_features_1m.parquet', output_file='candle_signals.csv'):
    """
    ...
    """
    print(f"📈 Генерация \"свечных\" сигналов из {data_file}...")
    ...
    print(f"💾 Сохранено {len(signals_df)} сигналов в {output_file}")
