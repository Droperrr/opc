#!/usr/bin/env python3
"""
Скрипт для запуска бэктеста стратегии Mean Reversion
"""
...
def main():
    ...
    print("=" * 60)
    print("🚀 ЗАПУСК БЭКТЕСТА СТРАТЕГИИ MEAN REVERSION")
    print("=" * 60)
    
    # Параметры бэктеста
    backtest_params = {
        'data_file': 'features_mean_reversion.parquet',
        'z_score_threshold': 2.0,  # Порог для стратегии Mean Reversion
        ...
        'results_dir': 'backtest_results_mean_reversion',
        'asset': 'SOL',
        'signal_generator_module': 'mean_reversion_signal_generator'  # Указываем новый генератор сигналов
    }
