#!/usr/bin/env python3
"""
Скрипт для запуска бэктеста "профессиональной" стратегии с новыми признаками
"""
...
def main():
    ...
    print("=" * 60)
    print("🚀 ЗАПУСК БЭКТЕСТА ПРОФЕССИОНАЛЬНОЙ СТРАТЕГИИ")
    print("=" * 60)
    
    # Параметры бэктеста
    backtest_params = {
        'data_file': 'basis_features_pro_1m.parquet',
        'z_score_threshold': 1.5,  # Изменен порог для новой стратегии
        ...
        'results_dir': 'backtest_results_pro',
        'asset': 'SOL'
    }
