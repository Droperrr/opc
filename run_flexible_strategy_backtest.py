#!/usr/bin/env python3
"""
Скрипт для запуска бэктеста гибкой стратегии с весовым коэффициентом тренд-фильтра
"""
...
def main():
    ...
    print("=" * 60)
    print("🚀 ЗАПУСК БЭКТЕСТА ГИБКОЙ СТРАТЕГИИ")
    print("=" * 60)
    ...
    backtest_params = {
        ...
        'results_dir': 'backtest_results_flexible',
        'asset': 'SOL'
    }
